...
export const Footer = () => {
  ...
  return (
    <footer className="w-screen h-20 bg-orange-400 flex flex-row px-8 items-center justify-between">
      <div className="text-white font-poppins font-semibold">
        Copyright © {year} Aldebarandev
      </div>
      <div className="flex flex-row gap-4">
        <Link href={"mailto:aldebaransdev@gmail.com"}>
          <svg
        ...
        <Link href={"https://github.com/derangga/foodpedia"}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 256 250"
            className="size-6"
